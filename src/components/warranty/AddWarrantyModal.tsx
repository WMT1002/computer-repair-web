              ...
              <div className="sm:col-span-4">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-900 border border-slate-600 rounded-lg pl-9 pr-3 py-2 text-xs text-slate-400 font-medium focus:outline-none focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400 placeholder-slate-500"
                  />
                </div>
              </div>
              ...
              <div className="sm:col-span-5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-900 border border-slate-600 rounded-lg pl-9 pr-3 py-2 text-xs font-mono text-slate-400 font-medium focus:outline-none focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400 placeholder-slate-500"
                  />
                </div>
              </div>
              ...
              <div className={matchedRepair ? "sm:col-span-5" : "sm:col-span-12"}>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-900 border border-slate-600 rounded-lg pl-9 pr-3 py-1.5 text-xs font-mono text-slate-400 font-medium focus:outline-none focus:border-cyan-400 placeholder-slate-500"
                  />
                </div>
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-900 border border-slate-600 rounded-lg pl-9 pr-3 py-2 text-xs text-slate-400 placeholder-slate-500 font-medium focus:outline-none focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-900 border border-slate-600 rounded-lg pl-9 pr-3 py-2 text-xs font-mono font-bold text-slate-400 placeholder-slate-500 focus:outline-none focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400 tracking-wider"
                />
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-slate-900 border border-slate-600 rounded-lg px-3 py-2 text-xs font-mono text-slate-400 font-medium focus:outline-none focus:border-cyan-400 placeholder-slate-500"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <div className="relative mb-1.5">
                ...
                <input
                  ...
                  className="w-full bg-slate-900 border border-slate-600 rounded-lg pl-9 pr-3 py-2 text-xs text-slate-400 placeholder-slate-500 font-medium focus:outline-none focus:border-cyan-400"
                />
              </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-slate-900 border border-slate-600 rounded-lg p-2 text-xs text-slate-400 placeholder-slate-500 font-medium focus:outline-none focus:border-cyan-400"
              />
            </div>
          </div>
        </form>
